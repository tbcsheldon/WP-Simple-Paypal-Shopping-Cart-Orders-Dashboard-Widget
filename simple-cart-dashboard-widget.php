<?php
/*
Plugin Name: WP Simple Paypal Cart Dashboard Widget
Description: List 'Cart Orders' custom post type
Version: 1.0
Author: Kyle Sheldon
Author URI: http://picklesmoochers.com/
...
class My_Dashboard_Widget {
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            __( 'Latest Orders Dashboard', 'nouveau' ),//Visible name for the widget
